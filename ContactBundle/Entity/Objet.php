 ...
 * @ORM\Entity(repositoryClass="ContactBundle\Repository\ObjetRepository")
...
class Objet
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="ContactBundle\Entity\Contact", mappedBy="objet")
     */
    private $contacts;
     ...
     * @return Objet
     */
    public function addContact(\ContactBundle\Entity\Contact $contact)
    {
     ...
     * @param \ContactBundle\Entity\Contact $contact
     */
    public function removeContact(\ContactBundle\Entity\Contact $contact)
    {
